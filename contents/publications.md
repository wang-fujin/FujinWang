...
- [6]. <strong>Wang F</strong>, Wu Z, Zhao Z, et al. Physical knowledge
guided state of health estimation of lithium-ion battery with limited segment data[J]. <span style="color: #25eb9cff; font-weight: 600;">Reliability Engineering & System Safety</span>, 2024, 251: 110325. [[Paper]](https://www.sciencedirect.com/science/article/abs/pii/S0951832024003971)

#### 2023


- [5]. <strong>Wang F</strong>, Zhao Z, Zhai Z, et al. Explainability-driven model improvement for SOH estimation of lithium-ion battery[J]. <span style="color: #25eb9cff; font-weight: 600;">Reliability Engineering & System Safety</span>, 2023, 232: 109046. [[Paper]](https://www.sciencedirect.com/science/article/abs/pii/S0951832022006615) [[Code]](https://github.com/wang-fujin/Explainability-driven_SOH)

- [4]. <strong>Wang F</strong>, Zhao Z, Zhai Z, et al. Feature disentanglement and tendency retainment with domain adaptation for lithium-ion battery capacity estimation[J]. <span style="color: #25eb9cff; font-weight: 600;">Reliability Engineering & System Safety</span>, 2023, 230: 108897. [[Paper]](https://www.sciencedirect.com/science/article/abs/pii/S0951832022005129) [[Code]](https://github.com/wang-fujin/battery_capacity_estimation)


- [3] <strong>王福金</strong>, 翟智, 邸一, 等. 基于分层对齐迁移学习的锂离子电池容量估计 [J]. <span style="color: #25eb9cff; font-weight: 600;">储能科学与技术</span>, 2023, 12(4): 1223. [[Paper]](https://esst.cip.com.cn/CN/10.19799/j.cnki.2095-4239.2022.0706)
[[Code]](https://github.com/wang-fujin/HATL)
...
- [2]. <strong>Wang F</strong>, Zhao Z, Ren J, et al. A transferable lithium-ion battery remaining useful life prediction method from cycle-consistency of degradation trend[J]. <span style="color: #25eb9cff; font-weight: 600;">Journal of Power Sources</span>, 2022, 521: 230975. [[Paper]](https://doi.org/10.1016/j.jpowsour.2022.230975)


#### 2021


- [1]. <strong>Wang F</strong>, Zhai Z, Zhao Z, et al. Remaining useful life prediction of lithium-ion battery based on cycle-consistency learning[C]. <span style="color: #25eb9cff; font-weight: 600;">2021 International
...
- [4]. Di Y, <strong>Wang F</strong>, Zhao Z, et al. An interpretable graph neural network for real-world satellite power system anomaly detection
based on graph filtering[J]. Expert Systems with Applications, 2024: 124348.
[[Paper]](https://www.sciencedirect.com/science/article/abs/pii/S0957417424012144)
